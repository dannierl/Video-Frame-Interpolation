...
- Qualitative Evaluation:
  ...
  - Visual demonstration based the image quality like the clear shape and the restored details.
...
The training of the model could also take longer time since it somehow depends on what hardware resources like GPU we would get for this project.
